...
user_profile = pd.read_csv('../data/xuetangx/user_info.csv', index_col='user_id')
...
user_cluster_id = pkl.load(open('../data/xuetangx/cluster/user_dict','r'))
cluster_label = np.load('../data/xuetangx/cluster/label_5_10time.npy')
