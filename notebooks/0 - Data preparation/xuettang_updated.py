...
train = pd.read_csv('../data/xuetangx/train_log.csv')
test = pd.read_csv('../data/xuetangx/test_log.csv')
train_truth = pd.read_csv('../data/xuetangx/train_truth.csv', index_col='enroll_id')
test_truth = pd.read_csv('../data/xuetangx/test_truth.csv', index_col='enroll_id')
