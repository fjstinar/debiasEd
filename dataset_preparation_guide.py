...
3. Save as data_dictionary.pkl in notebooks/data/your_dataset_name/
...
def prepare_dataset_template(csv_path, dataset_name, 
    ...
    output_dir = f"notebooks/data/{dataset_name}"
...
if __name__ == "__main__":
    ...
    print("2. 🛠️  Run example_student_grades() to see a complete example")  
