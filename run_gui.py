...
def main():
    ...
    if not Path("debiased_jadouille_gui.py").exists():
        print("Error: debiased_jadouille_gui.py not found in current directory")
        print("Please run this script from the directory containing the GUI files")
        return 1
