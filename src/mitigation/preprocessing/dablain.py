...
import mitigation.preprocessing.fair_over_sampling.Fair_OS as fair_sampler
...
class DablainPreProcessor(PreProcessor):
    ...
    def __init__(self, settings: dict):
        ...
        self._name = 'dablain et al.'
        self._notation = 'dablain'
        self._preprocessor_settings = self._settings['preprocessors']['dablain']
        self._information = {}
    ...
    def fit_transform(self, 
        ...
        oversampler = fair_sampler.FOS_1(
            proportion=self._preprocessor_settings['proportion'], n_neighbors=self._preprocessor_settings['k']
        ) 
