...
# class GrariInProcessor(InProcessor):
#     """inprocessing

#         References:
#             Grari, V., Ruf, B., Lamprier, S., & Detyniecki, M. (2019). Fairness-Aware Neural R\'eyni Minimization for Continuous Features. arXiv preprint arXiv:1911.04929.
#             https://github.com/fairml-research/HGR_NN/tree/main

#     """
    
#     def __init__(self, settings: dict):
#         super().__init__(settings)
#         self._name = 'grari et al.'
#         self._notation = ''
#         self._inprocessor_settings = self._settings['inprocessors']['grari']
#         self._information = {}
#         self._fold = -1
