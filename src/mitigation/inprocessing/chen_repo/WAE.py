...
def data_dis(dataset_orig_test,protected_attribute,dataset_used):
    ...
    if dataset_used == 'bank':
        ...
        if len(dataset_orig_test[(dataset_orig_test['Probability'] == 0) & (dataset_orig_test[protected_attribute] == 0)]) < zero_zero_new:
            ...
            zero_zero_set = dataset_orig_test[
                (dataset_orig_test['Probability'] == 0) & (dataset_orig_test[protected_attribute] == 0)].sample(
                n=zero_zero_new)
        if len(dataset_orig_test[(dataset_orig_test['Probability'] == 1) & (dataset_orig_test[protected_attribute] == 1)] > one_one_new):
        ...
        new_set = zero_zero_set._append([zero_one_set, one_zero_set, one_one_set], ignore_index=True)
