...
from mitigation.inprocessing.oneto_repo.GeneralFairERM import GeneralFairERM
...
class OnetoInProcessor(InProcessor):
    ...
    def __init__(self, settings: dict):
        ...
        self._name = 'Oneto et al.'
        self._notation = 'oneto'
        self._inprocessor_settings = self._settings['inprocessors']['oneto']
        self._information = {}
        self._fold = -1
