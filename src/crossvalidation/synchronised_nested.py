...
class SyncNestedXVal(CrossValidator):
    """Implements nested cross validation for the preprocessor and classification model, optimising for the classifier: 
    ...
    def _init_gs(self, fold):
        self._scorer.set_optimiser_function(self._xval_settings['sync_xval']['optim_scoring'])
        self._gs = self._gridsearch(
            preprocessor=self._preprocessor,
            model = self._model,
            grid=self._xval_settings['sync_xval']['paramgrid'],
            scorer=self._scorer,
