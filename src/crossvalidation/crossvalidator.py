...
class CrossValidator:
    ...
    def __init__(self, settings:dict, model:Predictor, scorer:Scorer):
        ...
        self._xval_settings = settings['crossvalidation']
        self._n_folds = settings['crossvalidation']['nfolds']
        self._pipeline = FeaturePipeline(settings)
        self._scorer =scorer
